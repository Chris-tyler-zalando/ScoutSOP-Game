ZALANDO SCOUT — SYSTEM UPDATE V2.60a
====================================
...
V2.60a additions and corrections:
...
- Kept the advanced map-builder controls from V2.60a.
...
- Kept the V2.60 boss logic/music fixes.
