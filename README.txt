ZALANDO SCOUT — SYSTEM UPDATE V2.61
====================================
...
V2.61 additions and corrections:
...
- Kept the advanced map-builder controls from V2.61.
...
V2.61:
- Rebuilt from structurally complete V2.59 because V2.60a-d accidentally removed large sections of game.js.
